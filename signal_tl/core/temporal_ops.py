...
from signal_tl.core.base import Expression, Parameter
...
class TemporalOp(Expression):
    ...
    def _latex(self, printer=None):
        ...
        if not interval.unbounded:
            symbol = ' {}_{{ {} }}'.format(symbol, interval.latex(printer))
        if self.nargs == 1:
...
__all__ = [
    'Until', 'Eventually', 'Always', 'Releases', 'Interval'
]
